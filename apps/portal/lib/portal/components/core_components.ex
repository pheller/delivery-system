...
defmodule Prodigy.Portal.CoreComponents do
  ...
  # Shield: the sandbox toggle. A sandboxed user's mutations are accepted and
  # acknowledged but rolled back, so it reads as containment rather than a ban.
  defp action_icon_paths(%{icon: :sandbox} = assigns) do
    ~H"""
